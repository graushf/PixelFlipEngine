...
unsigned int PXFRandom::Random(unsigned int n)
{
	unsigned long y;
...
void PXFRandom::SetRandomSeed(unsigned int n)
{
...
unsigned int PXFRandom::GetRandomSeed(void)
{
	return(rseed);
}

void PXFRandom::Randomize(void)
{
